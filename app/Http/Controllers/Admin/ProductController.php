...
class ProductController extends Controller
{
    ...
    public function update(ProductFormRequest $request, int $product_id)
    {
        ...
        if($product){
            ...
            return redirect('/admin/products')->with('message', 'Product successfully Update');
    ...
    public function destroy(int $product_id)
    {
        ...
        $product->delete();
        return redirect()->back()->with('message', 'Product Success Deleted');
    ...
    {
        $productColorData = Product::findOrFail($request->product_id)->productColors()->first();
